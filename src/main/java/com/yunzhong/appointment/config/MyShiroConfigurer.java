...
public class MyShiroConfigurer {
    ...
    private void loadShiroFilterChain(ShiroFilterFactoryBean factoryBean) {
        ...
        filterChainMap.put("/region/**", "anon");
        filterChainMap.put("/jsp/newestAnnoucement/listAnnouncement.jsp", "anon");
        filterChainMap.put("/jsp/newestAnnoucement/pageAnnouncement.jsp", "anon");
        filterChainMap.put("/baseinfo/**", "anon");        
        filterChainMap.put("/appointment/listIllness", "anon");
        filterChainMap.put("/appointment/listDept", "anon");
        filterChainMap.put("/appointment/deptDoctor", "anon");
        filterChainMap.put("/appointment/listDoctor", "anon");
        filterChainMap.put("/appointment/queryByillnessOrdoctor", "anon");
        filterChainMap.put("/appointment/queryByName", "anon");
        filterChainMap.put("/appointment/down", "anon");
