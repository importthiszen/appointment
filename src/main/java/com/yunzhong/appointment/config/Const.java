...
public class Const {
	...
	public static final Integer PAGE_SIZE2	= 10;				                            //分页每页最多显示条数
	...
	public static final String DEPEPARTMENT = "deptList";                          //小科室
	public static final String DEPEPARTMENTTYPE = "deptTypeList";                  //大科室
}
