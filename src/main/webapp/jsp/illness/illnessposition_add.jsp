				...
				<div class="container ">
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9">
							<input class="form-control" name="illtpName" value="" oninput="validatName(this.value)" onkeyup="this.value=this.value.replace(/\s+/g,'')" placeholder="请输入疾病名称" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class=" col-lg-6 col-md-6 col-sm-8 col-xs-8" >
							<div class="col-md-6 col-sm-6">
								<input class="form-control btn-primary" type="submit" id="tijiao" value="提交" />
							</div>
							<div class="col-md-6 col-sm-6">
...
<script type="text/javascript">
	function doSub(){
		 bootbox.confirm("确认提交吗?",function(r){
			 if(r){
				 $.ajax({
					type:"POST",
					url:"<%=request.getContextPath()%>/baseinfo/addIllPosition.action",
	...
	function validatName(){
		...
		if(illtpName != ""){
			$.ajax({
				type:"POST",
				url:"<%=request.getContextPath()%>/baseinfo/validatBigName.action",
