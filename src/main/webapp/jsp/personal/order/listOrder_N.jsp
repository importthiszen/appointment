					...
					<div class="page-content">
						<div class="row">
							...
							<form  method="post" name="infoForm" action="/personal/listOrder">
								<input name="order_state" value="N" type="hidden">
		...
		function payOrder(no,id,free){
			bootbox.dialog({  
			      ...
			      weixin: {  
			         ...
			         callback: function () {  
			         location.href = "<%=ctx%>/personal/payOrder?id="+id+"&type=weixin";
			                   }  
			         }
			       , zhifubao: {  
			         label: "支付宝",  
			         className: "btn-primary",  
			         callback: function () {  
			              location.href = "<%=ctx%>/personal/payOrder?id="+id+"&type=zhifubao";  
			                   }  
			              }  
			          }  
			}); 
