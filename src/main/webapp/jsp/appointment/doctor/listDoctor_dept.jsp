...
<html>
        ...
        <form method="post" >
			...
			<div class="container docInfo">
	        	<table width="100%" class="table table-hover">		        		        	
		        	...
		        	<tr>
		        		<td width="15%">
		        			<img src="<%=ctx %>/appointment/down?location=${t.ppPic}"  width="150px" height="170px;"/>	
		        		</td>
		        		<td width="70%">
	        ...
	        <div align="center">
			<ul class="pagination">
				<yzpage:page pageName="page" url="/appointment/deptDoctor" ></yzpage:page>
			</ul>
	        </div>
        </form>
	</body>
	...
	function tiaojian_search(){
		...
		function datatime(ppId){
			location.href = "<%=ctx%>/appt/apptlist?type=dept&ppId="+ppId;
		}
	</script>
</html>