...
<html>
        	...
        	<div class="col-sm-3">
        		<div class="panel">
        			...
        			<ul class="nav nav-tabs nav-stacked info_left">
        				...
        				%>
        				<li><a  href="javascript:info_change('<%=thirdMenu.getMenuUrl()%>')"><%=thirdMenu.getMenuName() %></a><input type="hidden" value="<%=thirdMenu.getMenuUrl()%>" name="selLi"></li>
        				<%
        								}
        				%>
        				</ul></li>
	...
	<script type="text/javascript">
		$(function(){
			var menuId = $("input[name='selLi']")[0].value;
			info_change(menuId);
		})
		//加载信息
