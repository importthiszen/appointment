...
<html>
	...
	<body>
        ...
        <form method="post" >
	        	...
	        	<table width="100%" class="table table-hover">		        	
		        	...
		        	<tr>
		        		...
		        		<td width="20%" style="vertical-align: middle;">
		        			<button type="button" class="btn btn-primary" onclick="datatime('${t.ppId}','${t.illId}')">现在预约</button>
		        		</td>
		        		</tr>
		        		</c:if>
		        		</c:forEach>	
	        ...
	        <div align="center">
			<ul class="pagination">
				<yzpage:page pageName="page" url="/appointment/queryByillnessOrdoctor"></yzpage:page>
			</ul>
	        </div>
        </form>
	</body>
	...
	function tiaojian_search(){
		...
		//跳转预约页面
		function datatime(ppId,illId){
			location.href = "<%=ctx%>/appt/apptlist?type=illness&ppId="+ppId+"&illId="+illId;
		}
	</script>
</html>