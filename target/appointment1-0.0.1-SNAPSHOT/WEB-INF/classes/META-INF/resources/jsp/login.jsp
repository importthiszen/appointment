			  		...
			  		<form class="form form-horizontal" name="loginForm1" action="${ctx}/success"  method="post" style="margin-top: 10px;">
        				...
        				<input type="hidden" style="display: none;"/>
			  			<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control" name="userName" required="true"  type="text" placeholder="请您输入有效手机号码"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-3 col-sm-offset-1">密码：</label>
							<div class="col-sm-4">
								<input class="form-control" required="true" name="userPass" type="password" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4 text-right">
								<a href="<%=ctx%>/register/recover" >忘记密码</a>
							</div>
						</div>
...
<%-- 			url = "<%=ctx%>/success"; --%>
// 			data = $("form[name='loginForm1']").serialize();
