...
<html>
			...
			<div class="container" style="margin-top: 20px;">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4>
							<label>疾病名称:${page.list[0].illName}</label>
							<span>
								<a href="../../appointment/listIllness">选择其他疾病</a>							
							</span>
						</h4>
					</div>
					<div class="panel-heading">
						<h4>
							<label>当前疾病简介:
							<font size="3">${page.list[0].illInfo}</font>
							</label>
						</h4>
					</div>
				</div>
	        	...
	        	<table width="100%" class="table table-hover">		        	
		        	...
		        	<tr>
		        		...
		        		<td width="70%">
						    ...
						    <h4 class="list-group-item-text">出诊时间：星期一，星期三</h4>
	...
	function tiaojian_search(){
		...
		function datatime(ppId){
			location.href = "<%=ctx%>/appt/apptlist?ppId="+ppId;
		}
	</script>
</html>